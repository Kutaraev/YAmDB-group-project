# Generated by Django 2.2.6 on 2021-09-30 17:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Category', to_field='slug', verbose_name='Категории')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(10, message='Рейтинг не должен быть выше 10'), django.core.validators.MinValueValidator(1, message='Рейтинг не должен быть ниже 1')])),
